...
const WarrantySection = () => (
  <Section>
    ...
    <div>
      <span>
<<<<<<< HEAD
        <p className="title">Compra garantida com a Nike</p>
        <p className="description">Receba o produto que está esperendo</p>
      </span>
      <span>
...
const Info = () =>(
  <Description>
    ...
    <p>
    Bola de Futebol NIKE - Brasileirão 2020
    <br/>
    <br/>
    Itens inclusos: <br />
    - 1 Bola <br/>
    <br/>
    As Bolas de futubol da Nike são as mais indicadas, para você craque, que ser o próximo craque da seleção.
    <br/>Com o material mais resistente já visto no mundo, as bolas da Nike são perfeitas para qualquer jogos em
    qualquer lugar.<br/>
    Não importa o campo, as pessoas.<br/>
    É NIKE ou nada !!!
    </p>
  </Description>
)
